      ...
      if (elms[i].getElementsByClassName('buttonStyle').length === 0) {
        ...
        btn1.onclick = function (e) {
          ...
          let selectedProduct = {
            ...
            price: elms[i].getElementsByClassName('product-tile__price')[0]
              .innerText,
            image: [
              elms[i].getElementsByClassName('product-image__image')[0]?.src,
              elms[i].getElementsByClassName('product-image__image')[1]?.src,
            ],
            id: generateHashCode(
              elms[i].getElementsByClassName('product-image__image')[0]?.src
            ),
...
attachCombinationButtons()
window.addEventListener('scroll', attachCombinationButtons)
